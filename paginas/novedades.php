    ...
    <div class="container my-4 hijo-2">
      <div class="row p-5 pb-5 pe-lg-5 pt-lg-5  rounded-3 border shadow-lg">
        <div>
          ...
          <br>
          <p class="lead">El estudiante debe de existir de lo contrario no se subirá el pago (módulo en proceso) </p><br>
          ...
          <form class="row" action="novedades.php" method="POST">
            <div class="col-6 ">
              ...
              <input type="text" class="form-control " id="inputAddress" placeholder="Escriba número de documento" name="documento_form" value="<?php if (isset($documento)) echo $documento ?>">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="date" class="form-control" name="fecha_form" value="<?php if (isset($fecha)) echo $fecha ?>">
            </div>
            <div class="col-md-6">
              <label for="inputState" class="form-label" value="<?php if (isset($fecha)) echo $fecha ?>">Empleado encargado</label>
              <!-- Lista desplegable -->
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="anexo_form" value="<?php if (isset($anexo)) echo $empleado ?>"></textarea>
            </div>
            <div class="col-12">
              <input type="submit" class="btn btn-primary btn-lg" name="btn_anexo">
            </div>
            <br>
