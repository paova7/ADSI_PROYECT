...
<body>
  ...
  <main >
    ...
    <!-- CONTENIDO DE MODULO DE ESTUDIANTES -->
    <div class="container my-5 hijo-2">
      <div class="row p-5 pb-5 pe-lg-5 pe-lg-5 rounded-3 border shadow-lg">
        <div class="text-center">
          <h1 class="display-4 fw-bold lh-2 text-center" >Conusulta estudiantil</h1>
          <br>
          <p class="lead text-center" > Ingresa el número de documento del estudiante del que quieres saber su estado en la instutución.
          </p><br>
          <div class="hijo">
            ...
            <div class="col-auto">
              ...
              <input class="form-control" id="inputPassword2" placeholder="Número de documento">
            </div>
            <div class="col-auto">
