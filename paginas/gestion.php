    ...
    <div class="container my-5 hijo-2">
      ...
      <div>
          ...
          ?>
                  ...
                  <br>
                  <div class="overflow-auto container p-4 p-md-12 border rounded-4 border bg-light bg-gradient p-2 border-5 text-center" style="padding: 100px;">
                        ...
                        <table class="table table-sm table-bordered">
                          <tbody>
                            ...
                            ?>
                              ...
                              <td scope="col">Nombres :<?php echo " " . $registro['id_estudiante']; ?></td>
